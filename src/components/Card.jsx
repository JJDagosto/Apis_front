...
const Card = ({arma, nombreSkin, estado,  precio, imagen}) => {
    return (
    <>
        <div className="card align-items-center flex-shrink-0" >
            <div className="contenedorImagen mt-3"><img src={imagen} className="card-img-top" alt="..." /></div>
            <div className="card-body d-flex flex-column align-items-start w-100 mx-5">
                ...
                <div className="d-flex justify-content-between align-items-center w-100 mt-3">
                    ...
                    <a href="#" className="btn d-flex align-items-center justify-content-center" id="cart"><FaShoppingCart /></a>
                </div>
